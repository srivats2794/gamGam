  ...
  'sleep-problems': [
    {
      ...
      expandedDetail: 'Magnesium glycinate is better absorbed than other forms and supports sleep by calming the nervous system. Take 300mg about 30 minutes before bed. It works gradually — give it 3–4 weeks before judging.',
      confidence: 'research-backed',
    ...
    },
    {
      ...
      expandedDetail: 'Ashwagandha (Withania somnifera) is an adaptogenic herb that helps regulate cortisol, which when elevated at night, disrupts sleep. Take 300–600mg of a root extract in the evening. The research is limited but women report it helps — and it is honest to say so.',
